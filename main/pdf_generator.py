...
async def generic_pdf(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    c.drawString(50, 710, user_answers['question0'])
    c.drawString(250, 710, user_answers['question1'])
    c.drawString(50, 665, user_answers['question2'])
    c.drawString(220, 665, user_answers['question3'])
    c.drawString(385, 665, user_answers['question4'])
    c.save()

    # Объединяем сформированный PDF с исходным
    ...
    await context.bot.send_document(chat_id=742290897, document=doc_path)
